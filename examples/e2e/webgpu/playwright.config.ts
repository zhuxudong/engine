...
const configuredUrl = process.env.WEBGPU_EXAMPLES_E2E_URL;
const baseUrl = new URL(configuredUrl ?? "http://127.0.0.1:5177");
...
export default defineConfig({
  ...
  reporter: "list",
  outputDir: process.env.WEBGPU_EXAMPLES_E2E_OUTPUT ?? path.join(os.tmpdir(), "galacean-webgpu-examples-e2e"),
