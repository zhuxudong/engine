...
export class Primitive extends GraphicsResource {
   ...
   * @param vertexBufferBindings - Optional per-draw vertex-buffer replacements.
   * @internal
   */
  _drawIndirect(
    ...
    this._platformPrimitive.drawIndirect(shaderProgram, subMesh, indirectBuffer, indirectOffset, vertexBufferBindings);
    this._bufferStructChanged = false;
  }
